  ...
  return (
    <div className={` flex justify-between ${timeAgo ? ' my-2 items-center' : 'my-6  space-y-1'}`}>
      ...
      <div className="relative rounded-lg group">
        ...
        <div
            className={`absolute inset-0 flex items-center justify-center bg-black bg-opacity-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 ease-in-out rounded-xl`}
          >
